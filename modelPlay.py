...
class QTrainer:
    ...
    def train_step(self,state,next_state,cardGuess,reward,done,legalMoves):
        ...
        for idx in range(len(done)):
            ...
            if not done_idx:
                next_predicted_q = self.model(next_state[idx])
                Q_new = reward[idx] + self.gamma * torch.max(next_predicted_q)
